...
export default {
  ...
  stats: {
    ...
    title: 'Statistik',
    filterGame: 'Spiel',
    filterAllGames: 'Alle Spiele',
    filterDifficulty: 'Stufe',
    played: 'Gespielt',
    solved: 'Gelöst',
    revealed: 'Lösung angezeigt',
    solveRate: 'Lösungsrate',
    avgDuration: 'Ø Dauer (gelöst, wertbar)',
    notEnoughData: 'Noch nicht genügend Daten',
    selectDifficultyPrompt: 'Spiel und Stufe wählen, um Trends zu sehen.',
    trendHeading: 'Letzte {count} vs. davor {count}',
    speedImprovement: 'Geschwindigkeit',
    speedNotComparable: 'nicht vergleichbar (keine wertbare Zeit)',
    solveRateChange: 'Lösungsrate-Änderung',
    exportButton: 'Testbericht exportieren (JSON)',
    exportedNote: 'Datei wurde heruntergeladen — bitte manuell an Drago senden.',
  },
